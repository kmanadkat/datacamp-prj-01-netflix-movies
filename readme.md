# Netflix Movies Duration Exploratory Data Analysis

## 1. Loading your friend's data into a dictionary
<p><img src="./assets/netflix.jpg" alt="Netflix Office USA"></p>
...
<p>Upon asking our friend for the original CSV they used to perform their analyses, they gladly oblige and send it. We now have access to the CSV file, available at the path <code>"./netflix_data.csv"</code>. Let's create another DataFrame, this time with all of the data. Given the length of our friend's data, printing the whole DataFrame is probably not a good idea, so we will inspect it by printing only the first five rows.</p>
...
print("\n")
print(netflix_df[['show_id', 'type', 'release_year', 'duration', 'genre']].head(5))
```
    ...
    0      s1  TV Show          2020         4  International TV
    1      s2    Movie          2016        93            Dramas
    2      s3    Movie          2011        78     Horror Movies
    3      s4    Movie          2009        80            Action
    4      s5    Movie          2008       123            Dramas
...
netflix_df_movies_only = netflix_df[
...
> This mini project is part of Datacamp's Data Scientist Certification curriculum.